...
save_path = r'G:\customer&fixed-position\xgb_model_3/'
...
for ID, mall in enumerate(mall_list):
    ...
    if LOAD:
        ...
        model = xgb.train(params, xgbtrain, num_rounds, watchlist, early_stopping_rounds=13)
    # 保存模型
    ...
    result.to_csv(path + 'sub6.csv', index=False)
